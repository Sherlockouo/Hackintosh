 ...
 *
 * Disassembly of ssdt-10.aml, Tue Apr 27 15:55:08 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001DDB (7643)
 *     Revision         0x01
 *     Checksum         0xCB
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.ACIC, IntObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.NVCB, IntObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.VGTT, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.PEG0.LNKS, IntObj)    // (from opcode)
    ...
    External (VRBN, IntObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            While (LNotEqual (\_SB.GGIV (0x01060004), One))
            {
                Sleep (One)
            }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            \_SB.SGOV (0x01020010, Zero)
            While (LNotEqual (\_SB.GGIV (0x01060004), Zero))
            {
                Sleep (One)
            }

            \_SB.SGOV (0x01020010, One)
        ...
        {
            If (LEqual (\_SB.GGIV (0x01060004), One))
            {
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                {
                    Store ("GPS fun 19", Debug)
                    If (LEqual (\_SB.PCI0.LPCB.EC0.ACIC, Zero))
                    {
                ...
                Case (0x2A)
                {
                    ...
                    If (LNot (\_SB.PCI0.LPCB.EC0.NVCB))
                    {
                        If (LEqual (\_SB.PCI0.LPCB.EC0.ACIC, Zero))
                        {
                            Notify (\_SB.PCI0.PEG0.PEGP, 0xD5)
                        ...
                        Store (One, \_SB.PCI0.LPCB.EC0.NVCB)
                    }
